		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'					onmouseover="jQuery(this).removeClass(\'ui-state-hover\').addClass(\'ui-state-default\');" '
					+	'						onmouseout="jQuery(this).removeClass(\'ui-state-default\').addClass(\'ui-state-hover\');"'
					+	'						class="ui-corner-all ui-state-default">'
					+	'				SET'
					+	'			</a>'
					+	'			<br style="clear: both;" /><div></div>'
...
jQuery.ptTimeSelect.setTime = function() {
	var myLength = jQuery('#ptTimeSelectUserSelHr').text().length;
	//alert(myLength);
	var myTime="";
	if(myLength==1){
		myTime="0"+jQuery('#ptTimeSelectUserSelHr').text();
	}else{
		myTime=jQuery('#ptTimeSelectUserSelHr').text();
	}
	//alert(myTime);
	var tSel = myTime
				+ ":"
	...
	/*if(document.getElementById('timeVal').value != "")  {
	
	}else{
		 var time_from=document.getElementById('timepicker1').value;
		var time_to=document.getElementById('timepicker2').value;
		var t1=document.getElementById('t1').value;
		var t2=document.getElementById('t2').value;
		if(t1 =='Time From') {
			document.getElementById('tf1').value=time_from;
			document.getElementById('client').value="";
		}	
		if(t2 =='Time To') {
			document.getElementById('tt1').value=time_to;
			document.getElementById('client').value="";
		} 	
	}*/
	this.closeCntr();
